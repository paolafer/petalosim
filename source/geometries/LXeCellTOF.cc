...
REGISTER_CLASS(LXeCellTOF, GeometryBase)

LXeCellTOF::LXeCellTOF(): GeometryBase(),
                          xy_size_(5.75*mm),
                          z_size_(5.*mm),
                          double_sipm_(false)
{
  msg_ = new G4GenericMessenger(this, "/Geometry/LXeCellTOF/",
                                "Control commands of geometry LXeCellTOF.");
...
LXeCellTOF::~LXeCellTOF()
{
  delete msg_;
}

void LXeCellTOF::Construct()
{
