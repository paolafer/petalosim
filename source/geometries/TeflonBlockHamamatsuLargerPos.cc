...
TeflonBlockHamamatsuLargerPos::TeflonBlockHamamatsuLargerPos(): teflon_block_thick_(35.75 * mm),
                                                    hole_length_(5*mm),
                                                    max_step_size_(1.*mm)
{
}

TeflonBlockHamamatsuLargerPos::~TeflonBlockHamamatsuLargerPos()
{
}


void TeflonBlockHamamatsuLargerPos::Construct()
{
